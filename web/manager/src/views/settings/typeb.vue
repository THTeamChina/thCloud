    ...
    <el-row v-if="items">
      <el-col :span="12" :xs="24" v-for="item in items" :key="item.Level">
        <div class="settingitem">
          <h2 style="margin:0;padding:0 0 20px">{{item.Type|memberTypeTxt}}</h2>
          <div>
            <span>游戏币提成:</span>
            ...
            <br />
            <span>加速释放:</span>
            <el-input v-model="item.JiaSu" style="width:60px;" size="mini"></el-input>
          </div>
        </div>
      </el-col>
    </el-row>
...
<script>
  import { getTypes, postTypes } from './api'
