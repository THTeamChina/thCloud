<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" class="filter-item" placeholder="名称" v-model="listQuery.key" clearable>
      </el-input>
    ...
    <powerForm :power="power" :visible="formVisiable" @update:visible="val => formVisiable = val" @success="fetchData"></powerForm>
  </div>
</template>
<script>
  import { getList, postStatus, delRobot } from './api'
  import powerForm from './form'
